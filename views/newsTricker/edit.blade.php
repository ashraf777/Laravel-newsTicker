    ...
    <aside class="right-side">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Article</li>
                <li class="active">Edit News Ticker</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4 class="panel-title">Edit New News Ticker</h4>
                        </div>
                        <div class="panel-body">
                                ...
                                <div class="table-responsive"> 
                                    ...
                                    {!! Form::model($newsT, array('method' => 'PATCH', 'route' => array('newsTricker.update', $newsT->id) )) !!}
                                        <div class="form-group">
                                            {!! Form::label('title', 'Title:', array('class' => 'col-sm-2 control-label')) !!}
                                            <div class="col-sm-10">
                                                {!! Form::text('title', $newsT->title, array('class' => 'form-control required', 'placeholder'=>'News Ticker title')) !!}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::label('details', 'Details:', array('class' => 'col-sm-2 control-label')) !!}
                                            <div class="col-sm-10">
                                                {!! Form::textarea('details', $newsT->details, array('style' => 'width: 100%; height: 104px;')) !!}
                                            </div>
                                        </div>
<!--                                         <div class="form-group">
                                            <div class="col-sm-2">
                                            ...
                                            <div class="col-sm-8" style="margin-left: 2px;">
                                                {!! Form::select('priority', array('' => 'Select', '1' => 'High', '2' => 'Medium', '3' => 'low'), 'High', array('class' => 'form-control required')) !!}
                                            </div>
                                        </div> -->
                                        <div class="form-group">
